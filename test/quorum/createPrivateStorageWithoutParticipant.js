...
if (nodeId === undefined || nodePubKey === undefined) {
  console.log('please run script with a nodeId. (ex: `node <script> 0`')
  return;
}
...
var txData = {
  ...
  privateFor: ["oNspPPgszVUFw0qmGFfWwh1uxVUXgvBxleXORHj07g8=", "1iTZde/ndBHvzhcl7V68x44Vx7pl8nwx9LqnM/AfJUg="]
};
